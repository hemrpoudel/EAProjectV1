				...
				<table class="table table-condensed table-striped table-bordered">
					...
					<c:forEach items="${CategoryList}" var="Category" varStatus="loopCounter">
								<tr  class="odd">
									...
									<td>
										<button class="btn btn-success" onclick="editCategory(${Category.id})">
<!-- 											<i class="fa fa-pencil"></i> Edit -->
										Edit </button> <a class="btn btn-danger"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<c:url var="actionUrl" value="saveProductBacklog" /><br><br>
				  ...
				  <form action="${actionUrl }" commandName="category" role="form" id="modalForm" method="post">
                  <div class="box-body">
                    <div class="form-group">
                     <label for="exampleInputEmail1">Name</label>
                    <textarea path ="name" name="name" class="form-control" id="name" placeholder="Enter name of category"> </textarea>
                      <label for="exampleInputEmail1">Description</label>
                       <textarea path ="description" name="description" class="form-control" id="description" placeholder="Enter Category Description"> </textarea>
                    </div>
                  </div><!-- /.box-body -->
